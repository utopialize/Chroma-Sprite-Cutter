...
const styles: Record<string, CSSProperties> = {
  ...
  title: { fontWeight: 700, fontSize: 18, letterSpacing: 0 },
  subtitle: { color: colors.textFaint, fontSize: fontSize.xs },
  stepper: {
    display: 'grid',
    ...
    <div style={styles.app}>
      <header style={styles.header}>
        <div style={styles.brand}>
          <span style={styles.title}>Chroma Sprite Cutter</span>
          <span style={styles.subtitle}>Local PNG cleanup and sheet builder</span>
        </div>
