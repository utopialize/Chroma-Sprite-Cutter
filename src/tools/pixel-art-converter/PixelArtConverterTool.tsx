...
export function PixelArtConverterTool() {
  ...
  const pixelArt = useMemo(() => {
    ...
    settings.trimSubjectEnabled,
    settings.subjectPaddingPx,
    settings.colorCount,
    settings.paletteMode,
    settings.palettePreset,
    settings.dithering,
    settings.pixelCleanupEnabled,
    settings.pixelCleanupStrength,
    settings.darkEdgeEnabled,
    settings.darkEdgeStrength,
    settings.darkEdgeMode,
    settings.darkEdgeColorMode,
    settings.darkEdgeRespectPalette,
